...
But the other 3 of the 5 replying servers contain the updated value(as all 6 servers were needed to be updated for write to succeed Nw=6).
Now we can decide these two servers are lying by seeing servers with same value among servers with the highest version number and 3 servers 
will tell the truth here, forming a majority. 
